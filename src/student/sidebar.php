<div class="sidebar">
    <div>
        <ul>
            <li><a href="announcements.php"><img src="../../assets/icons/icons8-announcement-100.png">Vision Mission</a></li>
            <li><a href="announcements.php"><img src="../../assets/icons/icons8-announcement-100.png">Dashboard</a></li>
